...
I have numbered each query title to make it easy for reviewers and future analysts to get an idea of the number of query catergories learned. Additionally, I replace Matt Mike's examples with my own as learn each type of query.
